...
// LDAPIdentity retrieves credentials from Hanzo S3
...
// RetrieveWithCredContext gets the credential by calling the Hanzo S3 STS API for
...
// Retrieve gets the credential by calling the Hanzo S3 STS API for
// LDAP on the configured stsEndpoint.
